...
{
    const AMASTY_COMPANY_USER_CREATE = 'amasty_company/user/create';
    const AMASTY_COMPANY_USER_EDIT = 'amasty_company/user/edit';
    const AMASTY_COMPANY_USER_STATUS_CHANGE = 'amasty_company/user/statusChange';
    const AMASTY_COMPANY_USER_DELETE = 'amasty_company/user/delete';
    ...
    {
        return $this->_urlBuilder->getUrl(self::AMASTY_COMPANY_USER_CREATE);
    }
    ...
    {
        return $this->_urlBuilder->getUrl(self::AMASTY_COMPANY_USER_EDIT, ['entity_id' => $entityId]);
    }
