...
{
    const AMASTY_COMPANY_PROFILE_SAVE_COMPANY = 'amasty_company/profile/saveCompany';
    const AMASTY_COMPANY_PROFILE_UPDATE_COMPANY = 'amasty_company/profile/updateCompany';
