...
{
    const AMASTY_COMPANY_ROLE_EDIT = 'amasty_company/role/edit';
    const AMASTY_COMPANY_ROLE_DELETE = 'amasty_company/role/delete';
    const AMASTY_COMPANY_ROLE_CREATE = 'amasty_company/role/create';
    ...
    {
        return $this->_urlBuilder->getUrl(self::AMASTY_COMPANY_ROLE_EDIT, ['role_id' => $roleId]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl(self::AMASTY_COMPANY_ROLE_CREATE);
    }
