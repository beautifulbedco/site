...
interface CompanyInterface extends CompanyExtensionInterface
{
    const TABLE_NAME = 'amasty_company_account_company';
    ...
    const REJECT_AT = 'rejected_at';
    const CUSTOMER_IDS = 'customer_ids';
    const RESTRICTED_PAYMENTS = 'restricted_payments';
    const USE_COMPANY_GROUP = 'use_company_group';
